...
function FooterThree(){
    return(
        <section className="my-4">
            <CopyButton id="#FooterThree"/>
            <div className="flex flex-col md:flex-row">              
              <div id="code-3" className="w-full p-4 rounded-lg text-gray-800">                 
                        ...
                        <section className="mb-3 text-gray-800 text-center lg:text-left">
                            <footer className="bg-neutral-900 text-center text-white">
                                    ...
                                    <form action="">
                                      <div
                                        ...
                                        <div className="relative md:mb-6" data-te-input-wrapper-init>
                                          <input
                                            type="text"
                                            className="peer block min-h-[auto] w-full rounded border-2 bg-transparent py-[0.32rem] px-3 leading-[1.6] text-neutral-200 outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                ...
                                <div className="p-4 text-center" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
                                    © 2023 Copyright:
                                    <a className="text-white" href="https://github.com/lewisushindi/Aurora-ComKit">
                                        Aurora-ComKit
                                    </a>
                                </div>
                              </footer>
