...
function FeatureThree() {
  return (
    <section className="my-4">
      <CopyButton id="#FeatureThree" />
      <div className="flex flex-col md:flex-row">              
              <div id="FeatureThree" className="w-full bg-gray-100 p-4 rounded-lg text-gray-800">                 
                                    ...
                                    <div className="flex flex-wrap items-center">
                                        ...
                                        <div className="flex flex-wrap">
                                            ...
                                            <div className="flex">
                                                ...
                                                <div className="p-4 bg-blue-600 rounded-md shadow-lg">
                                            ...
                                            <div className="flex">
                                                <div className="shrink-0">
                                                <div className="p-4 bg-blue-600 rounded-md shadow-lg">
                                                    <svg className="w-5 h-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                                    <path fill="currentColor"
