...
function CtaThree(){
    return(
        <section className="my-4">
            <CopyButton id="#CtaThree"/>
            <div className="flex flex-col md:flex-row">              
              <div id="code-3" className="w-full bg-gray-100 p-4 rounded-lg text-gray-800">                
                    
                    <div className="container my-24 px-6 mx-auto">
                        <section className="mb-3 text-gray-800 text-center lg:text-left">
                            <div className="px-6 py-6 md:px-12" style={{ backgroundColor: "hsl(0, 0%, 96%)" }}>
                                            ...
                                            <form>
                                                ...
                                                <div className="flex justify-center">
                                                    <a href="#!" role="button"
                                                        ...
                                                        {/* <!-- Facebook --> */}
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="w-4 h-4 mx-4">
                                                    ...
                                                    <a href="#!" role="button"
                                                        className="text-blue-600 hover:text-blue-700 focus:text-blue-700 action:text-blue-800 transition duration-200 ease-in-out">
                                                        {/* <!-- Google --> */}
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512" className="w-4 h-4 mx-4">
                                                        {/* <!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
                                                        <path fill="currentColor"
                                                    ...
                                                    <a href="#!" role="button"
                                                        className="text-blue-600 hover:text-blue-700 focus:text-blue-700 action:text-blue-800 transition duration-200 ease-in-out">
                                                        {/* <!-- Twitter --> */}
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 mx-4">
                                                        {/* <!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
                                                        <path fill="currentColor"
                                                    ...
                                                    <a href="#!" role="button"
                                                        className="text-blue-600 hover:text-blue-700 focus:text-blue-700 action:text-blue-800 transition duration-200 ease-in-out">
                                                        {/* <!-- Github --> */}
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-4 h-4 mx-4">
                                                        {/* <!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
                                                        <path fill="currentColor"
