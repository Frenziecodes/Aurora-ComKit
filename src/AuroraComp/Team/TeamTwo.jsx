...
function TeamTwo(){
    return(
        <section className="my-4">
            <CopyButton id="#TeamTwo"/>
            <div className="flex flex-col md:flex-row">              
              <div id="TeamTwo" className="w-full bg-gray-100 p-4 rounded-lg text-gray-800">                 
                                    ...
                                    <div className="grid gap-x-6 lg:gap-x-12 md:grid-cols-3">
                                        ...
                                        <div className="mb-12 md:mb-0">
                                            <div className="rounded-lg shadow-lg h-full block bg-white">
                                                <div className="flex justify-center">
                                                <div className="flex justify-center" style={{ marginTop: '-75px' }}>
                                                    <img src="https://mdbootstrap.com/img/new/avatars/8.jpg" className="rounded-full mx-auto shadow-lg" alt=""
                                                    style={{width: '150px'}} />
                                                </div>
                                                </div>
                                                <div className="p-6">
                                        ...
                                        <div className="mb-12 md:mb-0">
                                            <div className="rounded-lg shadow-lg h-full block bg-white">
                                                <div className="flex justify-center">
                                                <div className="flex justify-center" style={{ marginTop: '-75px' }}>
                                                    <img src="https://mdbootstrap.com/img/new/avatars/15.jpg" className="rounded-full mx-auto shadow-lg" alt=""
                                                    style={{width: '150px'}} />
                                                </div>
                                                </div>
                                                <div className="p-6">
