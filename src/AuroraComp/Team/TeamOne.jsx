...
function TeamOne(){
    return(
        <section className="my-4 lg:w-[1200px]">
            <CopyButton id="#TeamOne"/>
            <div className="flex flex-col md:flex-row">              
              <div id="TeamOne" className="w-full bg-gray-100 p-4 rounded-lg text-gray-800">                 
                    <div className="container my-4 px-6 mx-auto">                
                        <section className="mb-3 text-gray-800 text-center lg:text-left">                           
                            <div className="container my-6 px-6 mx-auto">
                                <section className="mb-4 text-gray-800 text-center">
                                    ...
                                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 lg:gap-xl-12">
                                        ...
                                        <h5 className="text-lg font-bold mb-4">Alan Turing</h5>
                                        ...
                                        <div className="mb-6 lg:mb-0">
                                        <img className="rounded-lg shadow-lg mb-6 mx-auto" src="https://mdbootstrap.com/img/Photos/Avatars/img%20(4).jpg"
                                            alt="avatar" style={{width: '150px'}} />
                                        <h5 className="text-lg font-bold mb-4">Veronica Smith</h5>
                                        ...
                                        <img className="rounded-lg shadow-lg mb-6 mx-auto" src="https://mdbootstrap.com/img/Photos/Avatars/img%20(32).jpg"
                                            alt="avatar" style={{width: '150px'}} />
                                        <h5 className="text-lg font-bold mb-4">Tom Johnson</h5>
                                        ...
                                        <div className="mb-6 md:mb-0">
                                        <img className="rounded-lg shadow-lg mb-6 mx-auto" src="https://mdbootstrap.com/img/Photos/Avatars/img%20(31).jpg"
                                            alt="avatar" style={{width: '150px'}} />
                                        <h5 className="text-lg font-bold mb-4">Emma Lovelace</h5>
